...
import movil.unicauca.peliculas.databinding.ActivityProximosEstrenosBinding;
...
public class ProximosEstrenosActivity extends AppCompatActivity implements ProximosEstrenosAdapter.OnProximosEstrenosListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_proximos_estrenos);

        Datape.data = new ArrayList<>();

        adapter = new ProximosEstrenosAdapter(getLayoutInflater(), this); //se instancia el adapter
